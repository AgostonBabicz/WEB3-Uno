...
export type MakeGame = (randomizer: Randomizer, shuffler: Shuffler<Card>, cardsPerPlayer: number, players?: string[], targetScore?: number, options?: { deferFirstRound?: boolean }) => Game